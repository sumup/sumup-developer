...
description: Learn how SumUp supports PSD2 Open Banking, including merchant impact, TPP access, and interface performance reports.
sidebar:
  label: Open Banking
  order: 100
# Nimbus's route map contains Astro pages, not static files under public/.
nimbusDisableRules:
