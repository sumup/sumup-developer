---
title: Accept payments with PrestaShop
description: Accept payments using SumUp with PrestaShop.
sidebar:
  label: PrestaShop
---
...
<LinkButton href="https://addons.prestashop.com/en/payment-card-wallet/44630-sumup-payment.html">
...
1. Follow the instructions described in [the register application guide](/online-payments/introduction/register-app) in order to obtain the client credentials for your app.
2. Download the client credentials JSON as described in the [access client credentials section](/online-payments/introduction/register-app/#4-access-the-client-credentials)
