...
See [Swift Checkout Documentation](/online-payments/checkouts/swift-checkout/) for more information.
...
- You could process [recurring payments](https://developer.sumup.com/online-payments/guides/tokenization-with-payment-sdk)
