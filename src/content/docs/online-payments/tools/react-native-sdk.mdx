...
- `checkoutId` - described in section [Create a checkout](/online-payments/tools/react-native-sdk/#create-a-checkout).
...
![](/img/guides/apple_pay_xcode_configurations.png)
