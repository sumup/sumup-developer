...
<CodeExamples
  ...
  "personal_details": {
    ...
    },
    {
      label: "JavaScript",
      lang: "ts",
      code: String.raw`const customer = await client.customers.create({
  customer_id: "MYCUSTOMERID-123",
  personal_details: {
    first_name: "Jeffrey",
    last_name: "Lebowski",
    ...
    },
    {
      label: ".NET",
      lang: "csharp",
      code: String.raw`var customer = await client.Customers.CreateAsync(new Customer
{
    ...
    },
    {
      label: "Java",
      lang: "java",
      code: String.raw`var customer = client.customers().createCustomer(
    Customer.builder()
        .customerId("MYCUSTOMERID-123")
        .personalDetails(
    ...
    },
    {
      label: "Go",
      lang: "go",
      code: String.raw`str := func(v string) *string { return &v }
...
PostalCode: str("90291"),
    ...
    },
    {
      label: "Python",
      lang: "py",
      code: String.raw`from sumup.customers.resource import CreateCustomerBody
...
postal_code="90291",
    ...
    },
    {
      label: "Rust",
      lang: "rust",
      code: String.raw`let customer = client
.customers()
...
.await?;`,
    },
    {
      label: "PHP",
      lang: "php",
      code: String.raw`$customer = $sumup->customers->create([
'customer_id' => 'MYCUSTOMERID-123',
'personal_details' => [
'first_name' => 'Jeffrey',
'last_name' => 'Lebowski',
...
<CodeExamples
  ...
  -d '{
    ...
    },
    {
      label: "JavaScript",
      lang: "ts",
      code: String.raw`const checkout = await client.checkouts.create({
  checkout_reference: "MYCHECKOUT",
  amount: 1,
  currency: "EUR",
  merchant_code: "MDEERENR",
  ...
  purpose: "SETUP_RECURRING_PAYMENT",
    ...
    },
    {
      label: ".NET",
      lang: "csharp",
      code: String.raw`var checkout = await client.Checkouts.CreateAsync(new CheckoutCreateRequest
{
    ...
    },
    {
      label: "Java",
      lang: "java",
      code: String.raw`var checkout = client.checkouts().createCheckout(
    ...
    },
    {
      label: "Go",
      lang: "go",
      code: String.raw`customerID := "MYCUSTOMERID-123"
...
Purpose: &purpose,
    ...
    },
    {
      label: "Python",
      lang: "py",
      code: String.raw`from sumup.checkouts.resource import CreateCheckoutBody
...
.await?;`,
    },
    {
      label: "PHP",
      lang: "php",
      code: String.raw`$checkout = $sumup->checkouts->create([
'checkout_reference' => 'MYCHECKOUT',
'amount' => 1,
'currency' => 'EUR',
'merchant_code' => 'MDEERENR',
...
<CodeExamples
  ...
  -H "Content-Type: application/json;charset=UTF-8"`,
    },
    {
      label: "JavaScript",
      lang: "ts",
      code: String.raw`const instruments = await client.customers.listPaymentInstruments("MYCUSTOMERID-123");`,
    },
    {
      label: ".NET",
      lang: "csharp",
      code: String.raw`var instruments = await client.Customers.ListPaymentInstrumentsAsync("MYCUSTOMERID-123");`,
    },
    {
      label: "Java",
      lang: "java",
      code: String.raw`var instruments = client.customers().listPaymentInstruments("MYCUSTOMERID-123");`,
    },
    {
      label: "Go",
      lang: "go",
      code: String.raw`instruments, err := client.Customers.ListPaymentInstruments(ctx, "MYCUSTOMERID-123")`,
    },
    {
      label: "Python",
      lang: "py",
      code: String.raw`instruments = client.customers.list_payment_instruments("MYCUSTOMERID-123")`,
    },
    {
      label: "Rust",
      lang: "rust",
      code: String.raw`let instruments = client
    .customers()
    ...
    },
    {
      label: "PHP",
      lang: "php",
      code: String.raw`$instruments = $sumup->customers->listPaymentInstruments('MYCUSTOMERID-123');`,
    },
  ]}
/>
