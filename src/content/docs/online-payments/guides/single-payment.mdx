...
This guide covers single payments over SumUp API, using customer-entered card details without associating them with a saved customer profile. Use this flow when you want to build your own payment form instead of using [Hosted Checkout](/online-payments/checkouts/hosted-checkout/) or the [Payment Widget](/online-payments/checkouts/card-widget/).
