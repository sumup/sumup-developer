...
SumUp provides official SDKs for JavaScript, Go, Python, Java, PHP, .NET, and Rust — visit the [SDKs overview page](/online-payments/sdks/) to choose the client that fits your stack.
