...
In this guide you will find the steps for a direct integration of Google Pay. This payment method is also available via the [SumUp Payment Widget](/docs/online-payments/tools/card-widget/).
...
- Validate your domain with Google [here](https://pay.google.com/business/console/)
