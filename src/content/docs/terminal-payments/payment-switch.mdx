...
- Integrate the [iOS URL scheme](https://github.com/sumup/sumup-ios-url-scheme)
- Integrate the [Android URL scheme](https://github.com/sumup/sumup-android-url-scheme)
