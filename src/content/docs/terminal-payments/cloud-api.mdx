...
<Tabs syncKey="backend_lang">
  ...
  <TabItem label="Go" icon="seti:go">
    ```go
    checkout, err := client.Readers.CreateCheckout(ctx, merchantCode, readerID, readers.CreateReaderCheckoutBody{
...
<Tabs syncKey="backend_lang">
  ...
  <TabItem label="PHP" icon="seti:php">
    ```php
    $sumup->readers->terminateCheckout($merchantCode, $readerId);
    ```
  </TabItem>
</Tabs>
...
<Tabs syncKey="backend_lang">
  ...
  <TabItem label="PHP" icon="seti:php">
    ```php
    $readers = $sumup->readers->list($merchantCode);
    ```
  </TabItem>
</Tabs>
