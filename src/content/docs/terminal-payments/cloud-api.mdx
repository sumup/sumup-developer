...
<Video
  src="/img/guides/pair_solo.mp4"
  trackSrc="/img/guides/pair_solo.vtt"
  width="400px"
  height="400px"
/>
...
<SoloScreen
  src="/img/guides/solo-pairing-step-7.png"
  alt="Solo device API pairing confirmation screen."
/>
...
<CodeExamples
  ...
  -d '{
    ...
    },
    {
      label: "JavaScript",
      lang: "ts",
      code: String.raw`const checkout = await client.readers.createCheckout(merchantCode, readerId, {
  total_amount: {
    currency: "EUR",
    minor_unit: 2,
    value: 1500,
    ...
    },
    {
      label: ".NET",
      lang: "csharp",
      code: String.raw`var checkout = await client.Readers.CreateCheckoutAsync(
    merchantCode,
    readerId,
    ...
    },
    {
      label: "Java",
      lang: "java",
      code: String.raw`var checkout = client.readers().createReaderCheckout(
    merchantCode,
    readerId,
    ...
    },
    {
      label: "Go",
      lang: "go",
      code: String.raw`checkout, err := client.Readers.CreateCheckout(ctx, merchantCode, readerID, sumup.CreateCheckoutRequest{
    ...
    },
    {
      label: "Python",
      lang: "py",
      code: String.raw`checkout = await client.readers.create_checkout(
    merchant_code,
    reader_id,
    ...
    },
    {
      label: "Rust",
      lang: "rust",
      code: String.raw`let checkout = client.readers().create_checkout(
    &merchant_code,
    &reader_id,
...
<CodeExamples
  ...
  -H "Authorization: Bearer $SUMUP_API_KEY"`,
    },
    {
      label: "JavaScript",
      lang: "ts",
      code: String.raw`await client.readers.terminateCheckout(merchantCode, readerId)`,
    },
    {
      label: ".NET",
      lang: "csharp",
      code: String.raw`await client.Readers.TerminateCheckoutAsync(merchantCode, readerId);`,
    },
    {
      label: "Java",
      lang: "java",
      code: String.raw`client.readers().createReaderTerminate(merchantCode, readerId, java.util.Map.of());`,
    },
    {
      label: "Go",
      lang: "go",
      code: String.raw`err := client.Readers.TerminateCheckout(ctx, merchantCode, readerID)`,
    },
    {
      label: "Python",
      lang: "py",
      code: String.raw`await client.readers.terminate_checkout(merchant_code, reader_id)`,
    },
    {
      label: "Rust",
      lang: "rust",
      code: String.raw`client.readers().terminate_checkout(&merchant_code, &reader_id).await?;`,
    },
  ]}
/>
...
<CodeExamples
  title="List Connected Readers"
  options={[
    {
      label: "cURL",
      lang: "bash",
      code: String.raw`curl https://api.sumup.com/v0.1/merchants/$SUMUP_MERCHANT_CODE/readers \
  -H "Authorization: Bearer $SUMUP_API_KEY"`,
    },
    {
      label: "JavaScript",
      lang: "ts",
      code: String.raw`const readers = await client.readers.list(merchantCode)`,
    },
    {
      label: ".NET",
      lang: "csharp",
      code: String.raw`var readers = await client.Readers.ListAsync(merchantCode);`,
    },
    {
      label: "Java",
      lang: "java",
      code: String.raw`var readers = client.readers().listReaders(merchantCode);`,
    },
    {
      label: "Go",
      lang: "go",
      code: String.raw`readers, err := client.Readers.List(ctx, merchantCode)`,
    },
    {
      label: "Python",
      lang: "py",
      code: String.raw`readers = await client.readers.list(merchant_code)`,
    },
    {
      label: "Rust",
      lang: "rust",
      code: String.raw`let readers = client.readers().list(&merchant_code).await?;`,
    },
  ]}
/>
