...
SumUp merchants operate in various industry segments, and we have made sure our card terminals are fit to accommodate a wide range of use cases and business approaches. We have outlined our merchants' most favored ones, along with what they find most beneficial from our services:
...
In order to fulfill other industries' business needs, you are offered a range of integration options through the [Payment SDK](/terminal-payments/sdks) and the [API](/terminal-payments/payment-switch) sections, and a full list of available services through the [API reference](/api) section.
