...
The Affiliate Key and Application ID coming from your app must match those obtained from the [Developers](https://me.sumup.com/developers?signup_intent=developer) page.
