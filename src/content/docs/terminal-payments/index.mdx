...
In order to fulfil other industries' business needs, you are offered a range of integration options through the [Payment SDK](/terminal-payments/tools/sdk) and the [API](/terminal-payments/tools/api) sections, and also a full list of available services through the [API reference](/api) section.
