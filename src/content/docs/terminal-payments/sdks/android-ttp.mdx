...
2. Create a Sandbox Account:
   ...
   <Image alt="Sandbox account" src="/img/guides/utopia-sandboxes.png" width="70%" />
...
3. In your new sandbox merchant account, create an [API key](https://me.sumup.com/settings/api-keys) or configure [OAuth2](https://me.sumup.com/settings/oauth2-applications) for authentication.
   ...
   <Image alt="Authentication approaches" src="/img/guides/utopia-auth-keys.png" width="70%" />

</Steps>

*Note*: These test accounts run in the production environment and allows you debug mode to be enabled in the SDK. To process live transactions with a real account, you must disable debug mode, otherwise, payments will not be executed.
