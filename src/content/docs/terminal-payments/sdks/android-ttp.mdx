...
- The Android Tap-to-Pay SDK sample app can be found [here](https://github.com/sumup/android-tap-to-pay). As noted below, credentials to access and use the SDK is restricted pending review and must be requested via our Integration team.
