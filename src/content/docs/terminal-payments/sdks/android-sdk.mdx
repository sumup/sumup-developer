...
Before calling any features of the { androidreadersdkname }, a registered SumUp merchant account needs to be logged in. Log in by supplying your Affiliate Key (your app’s application ID, e.g., com.sumup.sdksampleapp):
