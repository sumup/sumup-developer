...
To request access, contact [integration@sumup.com](mailto:integration@sumup.com).
...
For testing guidance, contact your SumUp technical contact or [integration@sumup.com](mailto:integration@sumup.com).
