...
<Callout type="tip">
  **Client-side options.** Looking for client-side or checkout experiences? See
  the [React Native SDK](/online-payments/sdks/react-native/) and [Swift Checkout
  SDK](/online-payments/checkouts/swift-checkout/).
</Callout>
