...
You can access all of our documentation as plain text markdown files by adding `index.md` to the end of any url. For example, you can find the plain text version of this page itself at https://developer.sumup.com/tools/llms/index.md.
