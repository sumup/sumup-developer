...
We also provide a self hosted MCP solution for direct integration with any MCP client that offers the standard API resources in case no customization is needed: [https://mcp.sumup.com/mcp](https://mcp.sumup.com/mcp)
