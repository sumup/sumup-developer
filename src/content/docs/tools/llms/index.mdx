...
If you're using AI coding assistants, use our [Agent Skills page](/tools/llms/agent-skills/) to install and run the [`sumup/sumup-skills`](https://github.com/sumup/sumup-skills) repository in tools like Claude Code, Cursor, and OpenAI Codex.
