...
description: Use SumUp in your agentic workflows.
sidebar:
  order: 54
---
...
Example usage of the [SumUp Agent Toolkit](https://github.com/sumup/sumup-ai) with the [OpenAI](https://github.com/openai/openai-node).
...
Example usage of the [SumUp Agent Toolkit](https://github.com/sumup/ai) with the [AI SDK](https://sdk.vercel.ai/).
