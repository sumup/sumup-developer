...
SumUp supports two authorization methods. [API keys](#api-keys) allow an app to authenticate and authorize on behalf of a merchant with full permissions. This simplest approach suits most use cases.
...
1. Log in to [https://me.sumup.com?signup_intent=developer](https://me.sumup.com?signup_intent=developer).
