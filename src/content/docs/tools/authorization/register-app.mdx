...
It's possible to edit the registered application details by clicking on it. The editing page allows updating the initial data and include **optional information** such as a "Logo", "Terms & Conditions" and "Privacy policy" URLs.
