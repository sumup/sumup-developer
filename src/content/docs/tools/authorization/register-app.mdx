...
- A [SumUp merchant account](https://me.sumup.com/login?signup_intent=developer) with completed [account details](https://me.sumup.com/account?signup_intent=developer) (or a [test account](/online-payments/#getting-a-test-account))
