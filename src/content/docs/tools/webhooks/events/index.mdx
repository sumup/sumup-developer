...
| Event Types                    | Description                                                | Status      |
| ------------------------------ | ---------------------------------------------------------- | ----------- |
| **`checkout.status.updated`**  | This event is triggered when a checkout status changed     | Available   |
| **`solo.transaction.updated`** | This event is triggered when a solo transaction is updated | in progress |
