...
To get started with SumUp, first [log in](/login). If you don't have a SumUp user account yet, register first. Then follow the [Activate my account](https://help.sumup.com/en-GB/articles/7gSOGSm2wEwIHyAvjitrLF) steps.
